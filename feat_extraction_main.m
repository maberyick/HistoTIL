...
addpath(genpath('./HistoTIL/libs'))
addpath(genpath('.HistoTIL/main_lib/'))
...
% test paths
folder_matpatches = '/home/maberyick/CCIPD_Research/Github/HistoTIL/testimage/patch_output/';
...
folder_type = 'folder_type'; % for folder, use 'folder_type'
